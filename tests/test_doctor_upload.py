...
def test_parse_issue_url():
    ...
    assert parsed == "https://github.com/alexangelzhang/qualix/-/issues/42"
...
def test_repo_path_from_url():
    ...
    assert (
        _repo_path_from_url("https://github.com/alexangelzhang/qualix/-/issues")
        == "alexangelzhang/qualix"
    )
    assert (
        _repo_path_from_url("https://github.com/alexangelzhang/qualix/issues")
        == "alexangelzhang/qualix"
...
def test_run_doctor_no_upload(tmp_path, capsys):
    ...
    (tmp_path / ".qualix" / "settings.yaml").write_text('qualix_version: "0.2.0"\nprofile: java-ddd\ncode_repos: []\n')
    rc = run_doctor(
