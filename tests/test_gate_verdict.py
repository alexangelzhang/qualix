...
class TestSaveLoadVerdict:
    def test_roundtrip(self, tmp_path):
        ...
        verdict = GateVerdict(
            ...
            upstream_hashes={"Q05a/phase_b_structured.json": "abc123"},
        )
        ...
        assert loaded.upstream_hashes == {"Q05a/phase_b_structured.json": "abc123"}
    ...
    def test_is_stale_file_unchanged(self, tmp_path):
        ...
        output_dir = tmp_path / "output"
        proj_dir = output_dir / "PROJ" / "Q05a"
        proj_dir.mkdir(parents=True)
        f = proj_dir / "phase_b_structured.json"
        f.write_text('{"x": 1}', encoding="utf-8")
        h = hashlib.md5(f.read_bytes()).hexdigest()

        verdict = GateVerdict(phase_id="Q06", upstream_hashes={"Q05a/phase_b_structured.json": h})
        assert verdict.is_stale(output_dir, "PROJ") is False
    ...
    def test_is_stale_file_changed(self, tmp_path):
        ...
        verdict = GateVerdict(phase_id="Q06", upstream_hashes={"Q05a/phase_b_structured.json": "stale_hash"})
    ...
    def test_is_stale_file_missing(self, tmp_path):
        ...
        verdict = GateVerdict(phase_id="Q06", upstream_hashes={"Q05a/phase_b_structured.json": "abc"})
