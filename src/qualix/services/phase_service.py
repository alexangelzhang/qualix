...
from qualix.path_utils import resolve_ingest_file, resolve_internal_file
...
def write_phase_profile_manifest(
    ...
    from qualix.core.profiles import get_profile, profile_to_payload, render_profile_context_markdown
