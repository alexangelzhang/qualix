...
from qualix.constants import LEGACY_PHASE_ID_MAP
from qualix.json_utils import load_json
from qualix.store import get_connection, migrate_all
...
def _page_token():
    ...
    try:
        from qualix.cache.semantic_cache import cache_stats
