...
from qualix.constants import LEGACY_PHASE_ID_MAP as LEGACY_PHASE_MAP
from qualix.constants import PHASE_DIR_MAP as PHASE_DIR
from qualix.json_utils import load_json

OUTPUT_DIR = Path("output")

PHASE_NAMES: Final = MappingProxyType(
    {
        "Q01": "需求结构化",
        "Q02": "技术方案生成",
        "Q03": "技术方案质量评审",
...
STATUS_LABEL: Final = MappingProxyType(
    {
        "approved": "已完成",
        "skipped": "已跳过",
        "pending_review": "待审核",
...
STATUS_COLOR: Final = MappingProxyType(
    {
        "approved": "#28a745",
        "skipped": "#6c757d",
...
DAG_COMMENT_TRANSLATE: Final = MappingProxyType(
    {
        "FAIL": "未通过",
        "PASS": "通过",
        "WARN": "警告",
...
EVAL_METRIC_ZH: Final = MappingProxyType(
    {
        "req_count": "需求点数",
        "br_count": "业务规则数",
        "se_count": "SE 数",
        "gap_count": "缺口数",
        "open_count": "待确认数",
        "se_with_basis": "SE 有依据率",
        "gap_with_risk": "GAP 有风险率",
        "open_with_owner": "OPEN 有负责人率",
        "critical_count": "严重问题数",
        "important_count": "重要问题数",
        "total_issues": "问题总数",
        "fm_count": "Failure Mode 数",
        "req_coverage_rate": "需求覆盖率",
        "se_coverage_rate": "SE 覆盖率",
        "gap_closure_rate": "GAP 闭环率",
        "missing_count": "未覆盖数",
    }
)

EVAL_STATUS_ZH: Final = MappingProxyType(
    {
        "NEW": "首次",
        "OK": "正常",
        "IMPROVED": "改善",
...
EVAL_STATUS_COLOR: Final = MappingProxyType(
    {
        "NEW": "#6c757d",
        "OK": "#28a745",
        "IMPROVED": "#17a2b8",
...
DIM_NAMES: Final = MappingProxyType(
    {
        "REQ": "需求覆盖",
        "BR": "业务规则",
        "SE": "场景覆盖",
...
UT_STATUS_ZH: Final = MappingProxyType(
    {
        "COVERED": "已覆盖",
        "MISSING": "未覆盖",
        "PARTIAL": "部分覆盖",
