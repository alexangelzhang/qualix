...
from qualix.core.model_registry import ModelProfile, get_model_profile
from qualix.core.state_machine import PHASE_DEFS, load_state
...
class LoadedContext:
    ...
    def render_evidence_pack(self) -> str:
        ...
        try:
            from qualix.quality.root_cause_tuner import get_adjusted_evidence_limits
        ...
        try:
            from qualix.context.chunking.prompt_compressor import compress, compression_ratio
...
def _assemble_context(
    ...
    from qualix.context.chunking.chunk_processor import _auto_compact_chunks, _split_large_chunk
