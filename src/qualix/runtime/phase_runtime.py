...
def runtime_execute(ctx: ExecutionContext) -> PhaseResult:
    ...
    from qualix.context.doc_summary import generate_summary_file
    from qualix.core.profiles import get_profile
    from qualix.reporting.telemetry import PhaseRunRecord, append_record
    from qualix.services.phase_service import write_phase_profile_manifest
    ...
    from qualix.context.phase_map import _UPSTREAM_MAP, generate_phase_map
    ...
    from qualix.runtime.lifecycle import run_pre_checks
...
def runtime_finalize(ctx: ExecutionContext) -> PhaseResult:
    ...
    from qualix.quality.cross_phase_check import check_cross_phase_refs
    from qualix.quality.finalize_checks import run_finalize_checks
    from qualix.reporting.telemetry import PhaseRunRecord, append_record
    ...
    from qualix.constants import STRUCTURED_JSON_MAP
    from qualix.quality.guardrail import GuardrailContext, GuardrailLevel, run_guardrails
    from qualix.quality.guardrail_impl import get_guardrails
    from qualix.quality.rule_checks import read_report
    ...
    from qualix.runtime.gate_verdict import build_verdict, load_rule_overrides, save_verdict
    ...
    try:
        from qualix.reporting.guard_precision_report import write_guard_precision_report
