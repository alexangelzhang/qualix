...
from qualix.ingest.common import warn
from qualix.ingest.feishu.asset_downloader import sanitize_filename
from qualix.ingest.feishu.auth import normalize_url, parse_feishu_url

# --- Backward-compatible re-exports ---
from qualix.ingest.feishu.block_parser import collect_mention_docs
from qualix.ingest.feishu.document_ingestor import (
    fetch_raw_content_with_fallback,
    ingest_single_document,
)
from qualix.ingest.feishu.mention_resolver import (
    finalize_edges as _finalize_edges,
)
from qualix.ingest.feishu.mention_resolver import (
    process_batch_results as _process_batch_results,
)
from qualix.ingest.feishu.output_builder import (
...
fetch_raw_content_with_fallback = fetch_raw_content_with_fallback
ingest_single_document = ingest_single_document
