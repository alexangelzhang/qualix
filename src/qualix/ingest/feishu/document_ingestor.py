...
from qualix.ingest.common import RAW_IMAGE_KEY_PATTERN, REQUEST_TIMEOUT_SECONDS, info, warn
from qualix.ingest.error_strategy import classify_error
from qualix.ingest.feishu.asset_downloader import append_raw_image_key_assets, download_assets
from qualix.ingest.feishu.auth import (
    call_with_token_fallback,
    normalize_url,
    resolve_input_doc,
)
from qualix.ingest.feishu.bitable_ingest import ingest_bitable
from qualix.ingest.feishu.block_parser import collect_mention_docs
from qualix.ingest.feishu.larkkit_ingest import ingest_via_larkkit
from qualix.ingest.feishu.segment_builder import build_segments_and_assets
...
def ingest_single_document(
        ...
        try:
            ...
            if download_images:
                ...
                if assets:
                    ...
                    if failed_boards:
                        from qualix.ingest.feishu.browser_fallback import browser_fallback_boards
    ...
    try:
        from qualix.ingest.text_preprocessor import preprocess_plain_text
