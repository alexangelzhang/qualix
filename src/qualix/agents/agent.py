...
from qualix.agents.llm_backends import LLMBackend, LLMConfig, create_backend
from qualix.constants import AGENT_EVIDENCE_EXCERPT_LIMIT, AGENT_EVIDENCE_TOTAL_LIMIT
from qualix.json_utils import dump_json_compact, dump_json_str
...
class Agent:
    ...
    def run(
        ...
        *,
        ...
        from qualix.reporting.telemetry_payload import (
        ...
        if self.output_dir:
            try:
                from qualix.store.prompt_versions import record_prompt_snapshot
