...
from qualix.constants import CASES_DIR, KNOWLEDGE_FILE_MAP, PHASE_DIR_MAP, SKILL_FILE_MAP
        ...
        "CONTEXT": MappingProxyType(
            {
                ...
                "targets": MappingProxyType(
                    {
                        "Q01": "src/qualix/ingest/feishu/",
                        "Q04": "src/qualix/context_loader.py",
                        "Q03": "src/qualix/context_loader.py",
                        "Q06": "src/qualix/context_loader.py",
                    }
                ),
            }
        ),
        "SCHEMA": MappingProxyType(
            {
                ...
                "targets": MappingProxyType(
                    {
                        "Q01": "src/qualix/schemas/phase_a.py",
                        "Q04": "src/qualix/schemas/phase_a5.py",
                        "Q03": "src/qualix/schemas/phase_a6.py",
                        "Q06": "src/qualix/schemas/phase_c.py",
                    }
                ),
            }
        ),
