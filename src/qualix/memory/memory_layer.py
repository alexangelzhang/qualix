...
from qualix.cache.code_search import format_search_results, index_java_repo, search_code
from qualix.cache.fact_cache import count_facts, index_phase_facts, search_facts
from qualix.cache.image_cache import save_batch as save_image_batch
from qualix.cache.image_cache import search_image_semantics
from qualix.cache.semantic_cache import cache_invalidate, cache_stats, cached_search
from qualix.cache.text_cache import cache_document, get_cache_stats, is_cached, search_text
...
from qualix.memory.version_tracker import (
...
class MemoryLayer:
    ...
    def index_phase(self, project_id: str, phase_id: str, force: bool = False) -> dict[str, Any]:
        ...
        from qualix.memory.knowledge_network import build_business_hyperedges
