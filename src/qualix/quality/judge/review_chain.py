...
from qualix.cache.llm_result_cache import get_cached_result
from qualix.core.state_machine import PHASE_DEFS
from qualix.core.state_machine import phase_dir as _phase_dir
from qualix.log import get_logger
from qualix.prompting import PromptAssembler, PromptBuild, PromptSpec, write_prompt_manifest
from qualix.prompting.record import record_prompt_manifest

from .critique import generate_critique_prompt
from .judge import generate_judge_prompt
...
def build_review_chain_payload(
    ...
    review_build = PromptAssembler.for_role("review_chain").assemble(
        ...
        section_sources={
            "judge_block": ("qualix.quality.judge", "qualix.cache.llm_result_cache"),
            "critique_block": ("qualix.quality.critique", "qualix.cache.llm_result_cache"),
            "preference_block": ("qualix.constants.REPORT_MAP",),
        },
