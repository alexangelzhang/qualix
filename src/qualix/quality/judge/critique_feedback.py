...
from qualix.constants import CASES_DIR, PHASE_DIR_MAP
from qualix.constants import PREFERENCE_LOG as _PREFERENCE_LOG
from qualix.core.state_machine import PHASE_DEFS
from qualix.core.state_machine import phase_dir as _phase_dir
from qualix.json_utils import dump_jsonl, load_json, save_json
...
def persist_preference(
    ...
    try:
        ...
        if preference.get("preferred") == "v2":
            ...
            if critique_data:
                from qualix.quality.regression.gene_store import extract_genes_from_preference, save_capsule, save_genes
