...
def cmd_auto(args, output_dir: Path) -> int:
    """全自动推进 pipeline."""
    from qualix.commands.cli_json import print_cli_json
    from qualix.commands.phase import _telemetry
    from qualix.commands.query import print_status
    from qualix.core.profiles import get_profile
    from qualix.runtime.execution_context import ExecutionContext
    from qualix.runtime.phase_runtime import runtime_execute, runtime_finalize
