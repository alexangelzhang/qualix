...
def _judge_replay(output_dir: Path, project_id: str, phase_id: str, model: str | None) -> dict:
    ...
    from qualix.constants import DEFAULT_FALLBACK_MODEL, DEFAULT_JUDGE_MODEL, REPORT_MAP
...
def cmd_judge(args, output_dir: Path) -> int:
    ...
    from qualix.quality.judge import format_judge_summary, load_judge_result, write_judge_prompt
...
def cmd_preference(args, output_dir: Path) -> int:
    from qualix.commands.cli_json import cli_envelope, cli_json_mode, print_cli_json
    from qualix.quality.critique import persist_preference, write_preference_prompt
...
def cmd_golden(args, output_dir: Path) -> int:
    from qualix.commands.cli_json import cli_envelope, cli_json_mode, print_cli_json
    from qualix.quality.golden_sample import compare_with_golden, format_golden_diff, save_golden
