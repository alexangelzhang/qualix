...
def cmd_dag(args, output_dir: Path) -> int:
    ...
    from dqg.core.state_machine import get_available_phases, get_parallel_groups, load_state
    ...
    if getattr(args, "plan", False):
        ...
        print(DAGScheduler.format_dag_plan(
            args.project_id, groups, skip_phases,
        ))
        return 0
