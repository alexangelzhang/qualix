...
def build_judge_prompt(
    ...
    from dqg.quality.eval.evaluation_protocols import get_protocol, render_protocol_for_prompt
    ...
    from dqg.quality.regression.gene_store import load_genes_for_phase, match_genes, render_genes_for_prompt
