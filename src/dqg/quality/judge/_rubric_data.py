    ...
    "Q06": {
        ...
        "dimensions": [
            ...
            },
            {
                ...
                "weight": 0.3,
                "rubric": {
                    5: "所有弱断言（assertNotNull/assertTrue(true)等）都被标记为 WRONG_TARGET；若产物中本身无弱断言，此维度直接给 5 分",
                    4: "90%+ 弱断言被检出，仅遗漏 1-2 个边界弱断言——此分数对应良好检出率，可 PASS_WITH_CONCERNS",
                    3: "主要弱断言被检出，但遗漏了只验证返回值不验证业务语义的情况（明显漏报）",
