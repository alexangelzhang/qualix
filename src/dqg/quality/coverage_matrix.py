...
def generate_coverage_matrix(
    ...
    matrix: dict[str, Any] = {
        ...
        "se_matrix": [
            {"id": r["id"], "description": r["description"], "status": "MISSING", "mapped_sections": [], "failure_impact": "", "notes": ""}
...
def _render_matrix_markdown(matrix: dict[str, Any]) -> str:
    ...
    s = matrix["summary"]
    lines.append(f"统计: REQ={s['total_req']} BR={s['total_br']} SE={s['total_se']} GAP={s['total_gap']} OPEN={s['total_open']}")
