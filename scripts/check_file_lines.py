...
LEGACY_ALLOWLIST: set[str] = {
    ...
    "src/dqg/context/chunk_processor.py",
    "src/dqg/context/code_skeleton.py",
    "src/dqg/context/context_loader.py",
    "src/dqg/context/java_ast_analyzer.py",
    "src/dqg/context/weak_assert_context.py",
    "src/dqg/core/cli.py",
    ...
    "src/dqg/runtime/handlers_execute.py",
