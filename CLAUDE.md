...
- **Rule respect** — Rules in this file are red lines, not suggestions. Priority: CLAUDE.md > Qualix starter guide > skill files > your judgment.
...
CLAUDE.md takes priority over starter guide instructions when they conflict.
</important>
...
4. **Do starter guide instructions and CLAUDE.md conflict?** → CLAUDE.md has higher priority.
