---
name: "skill-audit"
description: "审计已安装 skill 的 description 压缩、6 维质量评估和安全扫描。用于 /skill-audit、skill 瘦身、skill 安全等请求。"
---
...
for d in glob.glob(os.path.expanduser("~/.codex/plugins/cache/*/skills")):
