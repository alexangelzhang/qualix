...
如果用户已提供技术方案文档（本地路径或企业文档 URL），**直接跳过本 Phase**：
...
**禁止**回读原始 PRD 文档，Phase Q01 产物是唯一需求基线。
...
9. **阻断项（Blockers）** — P0 GAP 中无法在本次技术方案中解决的项，必须列出并说明原因；无阻断项时写"无"
10. **实施切片建议** — 切片/大小/内容/依赖
...
- 禁止输出 UT/EUT（单测是 Phase Q05a/Q06 的职责）
